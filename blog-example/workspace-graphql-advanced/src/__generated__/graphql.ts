...
export type PostListPageQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'BlogPost', date: string, formattedDate: string, title: string, teaser?: string | null, id: string }> };
...
export type PostPageQuery = { __typename?: 'Query', post?: { __typename?: 'BlogPost', id: string, title: string, date: string, formattedDate: string, body: string, likes: number } | null };
